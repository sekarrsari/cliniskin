...
<div class="font-['Poppins'] bg-gradient-to-r from-[#355186] to-[#687CA3] flex items-center justify-center min-h-screen">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <form class="max-w-sm lg:max-w-xl lg:w-2/5 mx-auto bg-[#F9F9F9] rounded-xl p-10 md:my-10">
            ...
            <div class="mb-5">
                ...
                <input type="email" id="email" class="bg-[#E9E9E9] border-none text-gray-900 text-sm rounded-lg focus:ring-[#355186] block w-full p-2.5" placeholder="name@gmail.com" required />
            </div>
            <div class="mb-5">
                <label for="password" class="block mb-2 text-base font-bold text-[#355186]">Password</label>
                <input type="password" id="password" class="bg-[#E9E9E9] border-none text-gray-900 text-sm rounded-lg focus:ring-[#355186] block w-full p-2.5" required />
            </div>
