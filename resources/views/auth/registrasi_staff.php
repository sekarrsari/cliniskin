<?php $title = 'CLINISKIN | Registasi Staff Klinik'; ?>
...
<div class="font-['Poppins'] bg-gradient-to-r from-[#355186] to-[#687CA3] flex items-center justify-center min-h-screen">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <img src="<?= urlpath('asset/img/regis-staff.png') ?>" alt="" class="mt-10 max-w-xs md:max-w-sm lg:max-w-md md:w-auto mx-auto md:mx-0 lg:ml-20 md:mr-2">
        ...
        <form class="max-w-sm lg:max-w-2xl lg:w-2/5 mx-auto bg-[#F9F9F9] rounded-xl p-10 md:my-10">
            ...
            <div class="mb-5">
                <label for="spesialisasi" class="block mb-2 text-base font-bold text-[#355186]">Spesialisasi</label>
                <select name="spesialisasi" id="spesialisasi" class="bg-[#E9E9E9] border-none text-gray-900 text-sm rounded-lg focus:ring-[#355186] block w-full p-2.5"
                required>
                    <option hidden value="">Pilih spesialisasi anda</option>
                    <option value="">Radiant Glow</option>
                    <option value="">Anti-Aging</option>
