    ...
    <div class="font-['Poppins'] bg-white">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
            <div class="flex flex-col items-center mt-20 mb-10 md:items-start md:my-32 md:ml-20 lg:mr-32">
                ...
                <a href="<?= urlpath('beranda-dokter/appointment') ?>" type="button" class="py-2 px-4 md:py-2.5 md:px-5 text-sm mb-6 font-medium text-white bg-[#92A5CA] rounded-lg drop-shadow-lg hover:bg-gray-200 hover:text-[#355186]">Lihat
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="flex flex-col items-center mb-10 md:items-end md:my-32 md:ml-20 lg:mr-32">
                ...
                <span class="text-white font-medium text-sm md:text-base mb-10 md:mb-12 lg:mb-14">Biodata dokter dan
                    status kerja</span>
                <a href="<?= urlpath('beranda-dokter/list-dokter') ?>" type="button" class="py-2 px-4 md:py-2.5 md:px-5 text-sm mb-6 font-medium text-white bg-[#355186] rounded-lg drop-shadow-lg hover:bg-gray-300 hover:text-[#355186]">Lihat
