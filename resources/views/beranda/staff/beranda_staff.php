<?php $title = 'CLINISKIN | Beranda Dokter'; ?>

<!-- Hero start -->
<section>
    <div class="bg-gradient-to-b from-[#355186] to-[#687DA3]">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between md:pl-5 lg:pl-20">
            ...
            <div class="flex flex-col items-center md:items-end text-white mr-8 mt-8 md:mt-0 md:ml-8 lg:mr-24">
                ...
                <span class="font-medium mb-6 md:mb-12 lg:mb-14 text-base lg:text-lg">Make Your Skin
                    Beautiful</span>
                <!-- <button type="button" class="py-2 px-4 md:py-2.5 md:px-5 text-sm mb-10 font-medium text-white bg-[#92A5CA] rounded-lg drop-shadow-lg hover:bg-gray-100 hover:text-[#355186]">Buat
                    Jadwal Treatment</button> -->
            </div>
        </div>
    </div>
</section>
    ...
    <div class="bg-white">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
            <div class="flex flex-col items-center mt-20 mb-10 md:items-start md:my-32 md:ml-20 lg:mr-32">
                ...
                <button type="button" class="py-2 px-4 md:py-2.5 md:px-5 text-sm mb-6 font-medium text-white bg-[#92A5CA] rounded-lg drop-shadow-lg hover:bg-gray-200 hover:text-[#355186]">Lihat
                    Kalender Treatment</button>
            </div>
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="flex flex-col items-center mb-10 md:items-end md:my-32 md:ml-20 lg:mr-32">
                ...
                <span class="text-white font-medium text-sm md:text-base mb-10 md:mb-12 lg:mb-14">Biodata dokter dan
                    status kerja</span>
                <button type="button" class="py-2 px-4 md:py-2.5 md:px-5 text-sm mb-6 font-medium text-white bg-[#355186] rounded-lg drop-shadow-lg hover:bg-gray-300 hover:text-[#355186]">Lihat
                    Daftar Dokter Cliniskin</button>
            </div>
