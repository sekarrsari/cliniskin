                    ...
                    <div class="bg-white p-8 rounded-lg">
                        <form>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <!-- Jenis Treatment -->
                                <div>
                                    <label for="jenistreatment" class="block text-sm font-medium text-gray-700">Jenis Treatment</label>
                                    <select name="jenistreatment" id="jenistreatment"
                                ...
                                <div>
                                    ...
                                    <select name="namadokter" id="namadokter"
                                        ...
                                        <option value="">dr. Eunike Sonbay</option>
                                        <option value="">dr. Shandra Jani</option>
                                        <option value="">dr. Cantika Cipta</option>
                                    </select>
                                </div>
                                <!-- Waktu Treatment -->
                                <div>
