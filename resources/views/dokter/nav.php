    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium text-black flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:bg-inherit md:text-white">
                <li>
                    <a href="<?= urlpath('beranda-dokter') ?>" class="block py-2 px-3 bg-[#687DA3] text-white rounded-lg hover:bg-gray-100 md:bg-transparent md:hover:bg-transparent md:border-0 md:hover:text-[#355186] md:p-0" aria-current="page">Home</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?= urlpath('beranda-dokter/profile') ?>" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#355186] md:p-0">Profile</a>
                </li>
                <li>
                    <a href="<?= urlpath('beranda-dokter/appointment') ?>" class="block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#355186] md:p-0">Appointment</a>
                </li>
            </ul>
        </div>
    </div>
