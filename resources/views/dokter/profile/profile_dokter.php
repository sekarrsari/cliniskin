                        ...
                        <form>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input value="<?=$user['nama']?>" disabled type="text" id="name" class="mt-1 block w-96 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="Shandra Jani">
                                </div>
                                <div>
                                    ...
                                    <div class="mt-1 flex">
                                        ...
                                        <input value="<?=$user['no_telp']?>" disabled type="text" id="phone" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="880-1000-1000">
                                    </div>
                                </div>
                                <div>
                                    <label for="address" class="block text-sm font-medium text-gray-700">Alamat</label>
                                    <input value="<?=$user['alamat']?>" disabled type="text" id="address" class="mt-1 block w-96 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="Jl. Sumatra No. 9, Sumbersari, Jember, Jawa TImur, 16012">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input value="<?=$user['email']?>" disabled type="email" id="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="shandrajani@gmail.com">
                                </div>
                            </div>
