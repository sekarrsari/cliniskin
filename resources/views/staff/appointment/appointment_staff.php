...
<div class="font-['Poppins'] bg-gradient-to-b from-[#A0ACC3] to-[#D6D6D6] min-h-screen flex justify-center">
                ...
                <div>
                    ...
                    <div id="dropdownRadio" class="z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg shadow"
                        ...
                        <ul class="p-3 space-y-1 text-sm text-gray-700" aria-labelledby="dropdownRadioButton">
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input data-id="30" id="filter-radio-example-3" type="radio" value="" name="filter-radio"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input data-id="last-month" id="filter-radio-example-4" type="radio" value="" name="filter-radio"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded hover:bg-gray-100">
                                    <input data-id="last-year" id="filter-radio-example-5" type="radio" value="" name="filter-radio"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2">
                ...
                <tbody id="tbody-appointment" class="font-medium">
                    <?php if(count($appointments)): ?>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                            <a href="<?= urlpath('beranda-staff/appointment/detail') ?>"
    ...
    <script src="../src/appointment-staff.js"></script>
