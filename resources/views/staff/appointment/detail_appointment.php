                    ...
                    <div class="bg-white p-8 rounded-lg ">
                        <form>
                            ...
                            <div class="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-4">
                                ...
                                <div class="mt-6 md:mt-0 lg:mt-0 md:col-span-2 md:ml-20">
                                    ...
                                    <select name="status" id="status" class="py-2.5 mt-1 block w-full md:w-2/3 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm bg-gray-100 pl-5" required>
                                        <option hidden value="">Pilih status treatment</option>
                            ...
                            <div class="flex justify-end mt-10">
                                <!-- Button Batal -->
                                <button type="button" class="text-[#355186] border border-[#355186] hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-1 text-center me-2 mb-2">Batal</button>
                                <!-- Button Simpan -->
                                <button type="button" class="text-white bg-[#355186] hover:bg-[#2b426d] border border-[#355186] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1 me-2 mb-2 focus:outline-none">Simpan</button>
                            </div>
                            <!-- Button end -->
